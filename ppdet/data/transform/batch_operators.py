...
__all__ = [
    ...
    'Gt2TTFTarget', 'Gt2Solov2Target', 'SegRescale',
]
...
class SegRescale(BaseOperator):
    ...
    def __call__(self, samples, context=None):
        # im_scale_x, im_scale_y = samples[0]['semantic'][0, :, :].shape
        # im_scale_x = int(im_scale_x * self.scale_factor)
        # im_scale_y = int(im_scale_y * self.scale_factor)
...
class PadBatch(BaseOperator):
    ...
    def __call__(self, samples, context=None):
        ...
        for data in samples: # new_im_h/w in mmdetection
            im = data['image']
            ...
            data['im_shape_pad'] = np.array([new_im_h, new_im_w])
